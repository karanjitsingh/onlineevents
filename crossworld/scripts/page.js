...
function logoutDisplay() {
	...
	statDisplay(rect.left + rect.width/2 - 60,rect.bottom + 10,0,"user");
}
...
function initMouseEvents() {
	...
	$id("user").onmouseover=logoutDisplay;
...
function validateJigsaw() {
	...
	for(var i=0;i<pieces.length;i++) {
		if(pieces[i].getAttribute("rot") != 0 && pieces[i].getAttribute("rot") != 360  ) {
			//console.log(pieces[i].getAttribute("rot"));
			return "";
		}
