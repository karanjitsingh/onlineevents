...
function register() {
	...
	var post={};
//console.log("name=" + fields[0] + "&registration=" + fields[1] + "&phone=" + fields[2] + "&email=" + fields[3] + "&college=" + fields[4] + "&username=" + fields[5] + "&password=" + fields[6]);
	//= "name=" + fields[0] + "&registration=" + fields[1] + "&phone=" + fields[2] + "&email=" + fields[3] + "&college=" + fields[4] + "&username=" + fields[5] + "&password=" + fields[6];
	post.name=fields[0];
	...
	$.post("./register/",post,resgiterCallback);
