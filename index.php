...
<style>
	...
	#leaderboard {
		position:absolute; width:800px;top:0px; left:50%; margin-left:-400px; height:100%; width:100%; background:#111; display:none;overflow-y:scroll;
	}
...
<div id="leaderboard">
	<table style=" width:700px; padding:50px; padding-top:100px; position:absolute; height:100%;">
	<tr>
		<td>
			<div style="width:700px; color:#ddd; padding:30px; box-sizing:border-box; background:rgba(255,255,255,0.1)">
				<span style="font-size: 22px;">Leaderboard</span>
				<ul>
				  <li><span>Mechatron</span><span><?php echo getMechatronLeaderboard(); ?></span></li>
				</ul>


  </div>
  <input type="button" class="cancel" value="Close" onclick="closePage()"/>
		</td>
	</tr>
	</table>
</div>
